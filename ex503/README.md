...
### How to run
#### Build & run locally
* Execute `./build.sh` inside the `ex503` directory. This will build the pingpong application, log writer and log reader 
...
* `EXTERNAL-IP` can be found from `kubectl get gateway ex503-gateway`
