...
then
  echo "Build image tag received as input: $LOG_READER_IMAGE_TAG"
    ...
    LOG_READER_IMAGE_TAG="dilansachi/devopswk8s-ex407-log-reader:1.0.0"
...
then
  echo "Build image tag received as input: $PING_PONG_APP_IMAGE_TAG"
    ...
    PING_PONG_APP_IMAGE_TAG="dilansachi/devopswk8s-ex407-ping-pong-application:1.0.0"
...
then
  echo "Build image tag received as input: $LOG_WRITER_IMAGE_TAG"
    ...
    LOG_WRITER_IMAGE_TAG="dilansachi/devopswk8s-ex407-log-writer:1.0.0"
