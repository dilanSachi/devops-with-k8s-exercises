...
then
  echo "Build image tag received as input: $TODO_APP_IMAGE_TAG"
    ...
    TODO_APP_IMAGE_TAG="dilansachi/devopswk8s-ex406-todo-app:1.0.0"
...
then
  echo "Build image tag received as input: $TODO_BACKEND_IMAGE_TAG"
    ...
    TODO_BACKEND_IMAGE_TAG="dilansachi/devopswk8s-ex406-todo-backend:1.0.0"
...
then
  echo "Build image tag received as input: $BROADCASTER_APP_IMAGE_TAG"
    ...
    BROADCASTER_APP_IMAGE_TAG="dilansachi/devopswk8s-ex406-broadcaster-app:1.0.0"
